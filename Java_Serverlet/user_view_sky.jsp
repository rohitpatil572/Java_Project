...
<html>
    ...
    <body class="body">
        ...
        <!-- inner banner -->
        <h1 class="heding">Sky shot crackers</h1><br>
    <!-- //inner banner -->
    ...
    Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from add_servises where category='Sky Shot'";
  ...
  <img src="<%=rs.getString("image")%>" class="card-img-top" alt="...">
  <div class="card-body">
