...
<html>
    ...
    <body class="body">
        ...
        <!-- inner banner -->
        <h1 class="heding">Decoration</h1><br>
    <!-- //inner banner -->
    ...
    Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from add_servises where category='Decoration'";
  ...
  <ul class="list-group list-group-flush">
      <li class="list-group-item">Design will change as per your choice</li>
