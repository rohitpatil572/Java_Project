...
<html>
    ...
    <body class="body">
        ...
        <!-- inner banner -->
        <h1 class="heding">Catering</h1><br>
    <!-- //inner banner -->
    ...
    Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from add_servises where category='Catering'";
  ...
  <ul class="list-group list-group-flush">
      <li class="list-group-item">Dishes as per your choice from menu list</li>
