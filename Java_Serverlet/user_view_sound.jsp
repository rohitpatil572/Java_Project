...
<html>
    ...
    <body class="body">
        ...
        <!-- inner banner -->
        <h1 class="heding">Sound system</h1><br>
    <!-- //inner banner -->
    ...
    Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from add_servises where category='sound system'";
  ...
  <ul class="list-group list-group-flush">
      <li class="list-group-item">Excellent sound quality</li>
