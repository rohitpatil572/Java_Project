...
<html>
    ...
    <body class="body">
       <div class="container">
        <div class="row">
            <div class="col-sm-2">
                ...
                <div class="col-sm-8">
                    ...
                    <form class="form " action="provider_add_service" method="post"> 
        ...
        <input type="text" name="txt_provider_nm" placeholder="Enter providre name" class="form-control" onkeypress="Javascript:return isString(event)" required>
            ...
            <input type="text" name="txt_contact" placeholder="Enter contact no1" class="form-control" onkeypress="Javascript:return isNumber(event)"maxlength="10" minlength="10" required>&nbsp;
                <input type="text" name="txt_contact2" placeholder="Enter contact no2" class="form-control" onkeypress="Javascript:return isNumber(event)"maxlength="10" minlength="10" required>
            ...
            <div class="row">
              ...
              <label>Category name</label>
                    <select name="txt_category" class="form-control">
                        ...
                        <option>Venue</option>
                        <option>Sky Shot carckers</option>
