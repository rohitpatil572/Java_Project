<%-- 
    Document   : home_singer
    Created on : May 23, 2023, 9:41:18 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body class="body">
        ...
        <div class="container"> 
            ...
            <div class="row"> 
                <div class="column">
                    <img src="./image/singer/singer1.jpg" style="width:100%">
                    <img src="./image/singer/singer2.jpg" style="width:100%">
                </div>
                <div class="column">
                    <img src="./image/singer/singer3.jpg" style="width:100%">
                    <img src="./image/singer/singer4.jpg" style="width:100%">
                </div>
                <div class="column">
                     <img src="./image/singer/singer5.jpg" style="width:100%">
                    <img src="./image/singer/singer6.jpg" style="width:100%">
                </div>
                <div class="column">
                    <img src="./image/singer/singer7.jpg" style="width:100%">
                    <img src="./image/singer/singer8.jpg" style="width:100%">
                </div>
